...
type ApiApiEmployeeGetRequest struct {
	ctx context.Context
	ApiService *EmployeeAPIService
}

func (r ApiApiEmployeeGetRequest) Execute() (*Employee, *http.Response, error) {
	return r.ApiService.ApiEmployeeGetExecute(r)
}

/*
ApiEmployeeGet Returns all employee.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiEmployeeGetRequest
*/
func (a *EmployeeAPIService) ApiEmployeeGet(ctx context.Context) ApiApiEmployeeGetRequest {
	return ApiApiEmployeeGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Employee
func (a *EmployeeAPIService) ApiEmployeeGetExecute(r ApiApiEmployeeGetRequest) (*Employee, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EmployeeAPIService.ApiEmployeeGet")
	if err != nil {
